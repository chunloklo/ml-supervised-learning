...
import numpy as np
test_acc = np.load("npData/20190207-221224-COVER-decisionTree-impurity-test_acc.npy")
train_acc = np.load("npData/20190207-221224-COVER-decisionTree-impurity-train_acc.npy")
# vals = np.linspace(20, 17118, num=10, dtype=int)
vals = np.load("npData/20190207-221224-COVER-decisionTree-impurity-vals.npy")

test_acc2 = np.load("npData/20190207-221438-COVER-decisionTree-max_depth-test_acc.npy")
train_acc2 = np.load("npData/20190207-221438-COVER-decisionTree-max_depth-train_acc.npy")
vals2 = np.load("npData/20190207-221438-COVER-decisionTree-max_depth-vals.npy")
...
plt.plot(vals, train_acc, marker='.',color=my_blue, label="Train")
plt.plot(vals, test_acc, marker='.', color=my_yellow, label="Validation")
...
plt.ylabel("Accuracy")
plt.ticklabel_format(style='sci', axis='x', scilimits=(0,0))
plt.plot(vals2, train_acc2, marker='.', color=my_blue, label="Train")
plt.plot(vals2, test_acc2, marker='.', color=my_yellow, label="Validation")
...
plt.savefig("../tex/images/COVER-decisionTree-tuning.pdf")
plt.show()
