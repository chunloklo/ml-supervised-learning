...
import numpy as np
test_acc = np.load("npData/20190206-173911-MAGIC-knn-n_neighbors-test_acc.npy")
train_acc = np.load("npData/20190206-173911-MAGIC-knn-n_neighbors-train_acc.npy")
vals = np.load("npData/20190206-173911-MAGIC-knn-n_neighbors-vals.npy")

test_acc2 = np.load("npData/20190208-155148-COVER-knn-n_neighbors-test_acc.npy")
train_acc2 = np.load("npData/20190208-155148-COVER-knn-n_neighbors-train_acc.npy")
vals2 = np.load("npData/20190208-155148-COVER-knn-n_neighbors-vals.npy")
...
plt.savefig("../tex/images/KNN-n_neighbor.pdf")
plt.show()
