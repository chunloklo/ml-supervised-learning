...
import numpy as np
test_acc = np.load("npData/20190206-005814_MAGIC-decisionTree_tuned-test_acc.npy")
train_acc = np.load("npData/20190206-005814_MAGIC-decisionTree_tuned-train_acc.npy")
vals = np.linspace(20, 17118, num=10, dtype=int)

test_acc2 = np.load("npData/20190207-222419-COVER-decisionTree-tuned-test_acc.npy")
train_acc2 = np.load("npData/20190207-222419-COVER-decisionTree-tuned-train_acc.npy")
# vals2 = np.load("npData/20190207-222419-COVER-decisionTree-tuned-vals.npy")
...
plt.savefig("../tex/images/decisionTree-learningCurve.pdf")
plt.show()
