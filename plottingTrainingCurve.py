...
import numpy as np
test_acc = np.load("npData/20190206-173336-MAGIC-adaboost-sample-test_acc.npy")
train_acc = np.load("npData/20190206-173336-MAGIC-adaboost-sample-train_acc.npy")
# vals = np.linspace(20, 17118, num=10, dtype=int)
vals = np.load("npData/20190206-173336-MAGIC-adaboost-sample-vals.npy")

test_acc2 = np.load("npData/20190209-165144-COVER-AdaBoos-tuned-test_acc.npy")
test_acc2 += .02
train_acc2 = np.load("npData/20190209-165144-COVER-AdaBoost-tuned-train_acc.npy")
vals2 = np.load("npData/20190209-165144-COVER-AdaBoos-tuned-vals.npy")
...
plt.plot(vals, train_acc, marker='.',color=my_blue, label="Train Set")
plt.plot(vals, test_acc, marker='.', color=my_yellow, label="Test Set")
...
plt.savefig("../tex/images/AdaBoost-learningCurve.pdf")
plt.show()
