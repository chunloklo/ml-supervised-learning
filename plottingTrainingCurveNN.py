...
MAGIC_hist = pickle.load(open('objData/20190208-140523-MAGIC-NN-104-history.pkl', 'rb'))
COVER_hist = pickle.load(open('objData/20190209-144637-COVER-NN-300-history.pkl', 'rb'))


val_acc = MAGIC_hist['val_acc']
train_acc = MAGIC_hist['acc']
vals= range(0, 30)

val_acc2 = COVER_hist['val_acc']
train_acc2 = COVER_hist['acc']
vals2= range(0, 300)

# train_acc = np.load("npData/20190208-151935-MAGIC-SVM-sample-train_acc.npy")
# # vals = np.linspace(20, 17118, num=10, dtype=int)
# vals = np.load("npData/20190208-151935-MAGIC-SVM-sample-vals.npy")

# test_acc2 = np.load("npData/20190208-181619-COVER-SVM-sample-test_acc.npy")
# train_acc2 = np.load("npData/20190208-181619-COVER-SVM-sample-train_acc.npy")
# vals2 = np.load("npData/20190208-181619-COVER-SVM-sample-vals.npy")
# # vals2 = np.linspace(20, 15120, num=10, dtype=int)
...
plt.plot(vals, train_acc,color=my_blue, label="Train Accuracy")
plt.plot(vals, val_acc,  color=my_yellow, label="Validation Accuracy")
...
plt.ylabel("Accuracy")
# plt.ticklabel_format(style='sci', axis='x', scilimits=(0,0))
plt.plot(vals2, val_acc2, color=my_yellow, label="Validation Accuracy")
plt.plot(vals2, train_acc2, color=my_blue, label="Train Accuracy")

# plt.plot(vals2, train_acc2, marker='.', color=my_blue, label="Train Set")
# plt.plot(vals2, test_acc2, marker='.', color=my_yellow, label="Test Set")
# plt.plot(vals, test_acc, marker='.', color='orange', label="Linear Test")
# plt.plot(vals, train_acc, marker='.',color='r', label="Linear Train")
# plt.plot(vals, test_acc2, marker='.', color='darkcyan', label="RBF Test")
...
plt.savefig("../tex/images/NN-learningCurve.pdf")
plt.show()
